...
<body>
 ...
 <div class="jumbotron col-md-6">
   <?php foreach($tulis as $r) {?>
     <?=form_open_multipart('menulis_a/proses_ubah/'.$r->id_tulis)?>
	 <div class="form-group">
      <label for="kode_tulis">Kode :</label>
      <input type="text" name="kode_tulis" class="form-control" placeholder="Masukan Kode Materi" id="kode_tulis" value="<?php echo $r->kode_tulis ?>" required>
    </div>
    <div class="form-group">
