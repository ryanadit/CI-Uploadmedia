...
<?php
$datatulis= $this->db->query("select id_baca,kode_baca,judul,keterangan,foto,audio from membaca");
...
<body>
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="<?php echo base_url('index.php/baca/dataa/1')?>">Belajar Membaca ya</a></li>
            </ul>
 ...
 <div class="container">
  ...
  <?php foreach($membaca as $r) {?>
     <?=form_open_multipart('tulis/proses_ubah/'.$r->id_baca)?>
...
<div class="card-header"></div>
<div class="card-body"><center>
	  <a href="<?php echo base_url();?>index.php/baca/dataa/<?php echo $row['id_baca']; ?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-music"></i> Pilih</a>
