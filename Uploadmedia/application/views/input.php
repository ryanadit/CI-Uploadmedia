...
<body>
  <!-- INI ADALAH HEADER -->
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="<?php echo base_url('index.php/membaca/data')?>">Data Materi</a></li>
              <li class="active"><a href="<?php echo base_url('index.php/membaca/input')?>">Input Materi</a></li>
            </ul>
   ...
   <br><br><br><br><br>
   <div class="container">
     <h3 align="center"><b>MASUKAN MATERI MEMBACA BARU</b></h3>
 <div class="col-md-3">
 </div>
 <div class="jumbotron col-md-6">
   <?=form_open_multipart('membaca/proses_input/')?>
   <div class="form-group">
      <label for="kode_baca">Kode :</label>
      <input type="text" name="kode_baca" class="form-control" placeholder="Masukan Kode Materi" id="kode_baca" required>
    </div>
    <div class="form-group">
